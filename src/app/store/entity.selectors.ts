...
import { EntityStateSelectors } from 'app/models/entity-state-selectors.interface';
...
>(selectFeature: MemoizedSelector<object, TState>): EntityStateSelectors<TEntity> {
    ...
    const selectEntityById = (id: string): MemoizedSelector<object, TEntity | undefined> =>
